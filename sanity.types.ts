...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Carousel | Sale | Order | Product | Series | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata;
...
// Source: ./sanity/lib/products/getProductsBySeriesName.ts
// Variable: PRODUCTS_BY_SERIES_QUERY
// Query: *[      _type == "product" &&      references(*[_type == "series" && name == $seriesName]._id)    ] {      _id,      name,      price,      stock,      description,      image,      series-> {        name      }    }
export type PRODUCTS_BY_SERIES_QUERYResult = Array<{
  _id: string;
  name: string | null;
  price: number | null;
  stock: number | null;
